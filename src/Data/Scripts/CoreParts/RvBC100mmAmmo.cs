...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RvBC100mmAmmo => new AmmoDef
        {
            AmmoMagazine = "RvBC100mmAmmo",
            AmmoRound = "RvBFlak100mm",
            ...
            {
                AmmoRound = "RvBC100mmShrapnelbase", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 0.5f,
                    CustomParticle = "RvBSmallArtExplosionLight",
            ...
            Ejection = new EjectionDef
            {
                ...
                {
                    ItemName = "RvBC100ShellCasing", //InventoryComponent name
        ...
        private AmmoDef RvBC100mmAmmoImpact => new AmmoDef
        {
            AmmoMagazine = "RvBC100mmAmmo",
            AmmoRound = "RvBHE100mm",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 90f, // in kilograms
        ...
        private AmmoDef RvBC100mmShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC100mmShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 150f,
            Mass = 15000f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 32f, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                // modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01 = 1% damage, 2 = 200% damage.
                Characters = -1f,
                VoxelHitModifier = 1,
                FallOff = new FallOffDef
        ...
        private AmmoDef RvBC100mmShrapnelbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC100mmShrapnelbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
