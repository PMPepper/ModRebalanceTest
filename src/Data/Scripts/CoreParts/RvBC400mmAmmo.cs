...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RvBC400mmAmmoAP => new AmmoDef
        {
            AmmoMagazine = "RvBC400AmmoAP",
            AmmoRound = "RvBC400AP",
            ...
            {
                AmmoRound = "RvBC400mmAPHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC400mmAmmoHE => new AmmoDef
        {
            AmmoMagazine = "RvBC400AmmoHE",
            AmmoRound = "RvBC400HE",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "RvBC400mmHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC400mmShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC400mmShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 2000f,
        ...
        private AmmoDef RvBC400mmAPHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC400mmAPHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvBC400mmHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC400mmHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
