...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition RvBC400mmTurret => new WeaponDefinition
        {
            ...
            Ammos = new[] {
                RvBC400mmAmmoAP, RvBC400mmShrapnel, RvBC400mmAmmoHE, RvBC400mmAPHEShrapbase, RvBC400mmHEShrapbase,

            },
            Animations = RvBC400Turret_Animation,
