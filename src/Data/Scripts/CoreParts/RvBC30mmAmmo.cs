...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef RvBC30mmAmmo => new AmmoDef
        {
            AmmoMagazine = "RvBC30Ammo",
            AmmoRound = "RvB30mmAmmoRound",
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    ...
                    MinMultipler = 0.9f, // value from 0.0f to 1f where 0.1f would be a min damage of 10% of max damage.
                },
        ...
        private AmmoDef RvBC30mmAmmoBlank => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "30mmAmmoBlank",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvBC30mmAmmoBlank2 => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "30mmAmmoBlank2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvB30mmFragment => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvB30mmFragment",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 0.8f,// 0 offset value disables this effect
                        MinLength = 0.2f,
                        MaxLength = 3,
                    },
                },
