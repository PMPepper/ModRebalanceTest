...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RvBC300mmAmmoAP => new AmmoDef
        {
            AmmoMagazine = "RvBC300AmmoAP",
            AmmoRound = "RvBC300AP",
            ...
            {
                AmmoRound = "RvBC300mmAPHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC300mmAmmoHE => new AmmoDef
        {
            AmmoMagazine = "RvBC300AmmoHE",
            AmmoRound = "RvBC300HE",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "RvBC300mmHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC300mmShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC300mmShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1000f,
        ...
        private AmmoDef RvBC300mmAPHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC300mmAPHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvBC300mmHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC300mmHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
