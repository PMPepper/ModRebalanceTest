...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RvBC500mmAmmoHE => new AmmoDef
        {
            AmmoMagazine = "RvBC500AmmoHE",
            AmmoRound = "RvBC500HE",
            ...
            {
                AmmoRound = "RvBC500mmHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC500mmHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC500mmHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
