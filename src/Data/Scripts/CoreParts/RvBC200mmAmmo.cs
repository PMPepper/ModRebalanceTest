...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RvBC200mmAmmo => new AmmoDef
        {
            AmmoMagazine = "RvBC200Ammo",
            AmmoRound = "RvBFlak200mm",
            ...
            {
                ModelName = "..\\2016817336\\Models\\203HowitzerRound.mwm",
        ...
        private AmmoDef RvBC200mmAmmoImpact => new AmmoDef
        {
            AmmoMagazine = "RvBC200Ammo",
            AmmoRound = "RvBHE200mm",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 120f, // in kilograms
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "RvBC200mmShrapnelbase",
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
        ...
        private AmmoDef RvBC200mmAmmoAP => new AmmoDef
        {
            AmmoMagazine = "RvBC200AmmoAP",
            AmmoRound = "RvBAP200mm",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 2000f,
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "RvBC200mmAPHEShrapbase",
                Fragments = 1,
                Reverse = false,
        ...
        private AmmoDef RvBC200mmShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC200mmShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.3f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 200f,
        ...
        private AmmoDef RvBC200mmShrapnelbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC200mmShrapnelbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvBC200mmAPHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC200mmAPHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RvBC200mmPDAOE => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RvBC200mmPDAOE",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
