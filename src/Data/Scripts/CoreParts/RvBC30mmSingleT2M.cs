...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition RvBC30mmSingleT2M => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        MuzzlePartId = "C30mmSingleEl2",
                        AzimuthPartId = "C500SubTurret2",
                        ElevationPartId = "C30mmSingleEl2",
                    },
                ...
                Scope = "muzzle_missile_5", //Where line of sight checks are performed from must be clear of block collision 
            },
            ...
            {
                PartName = "30mm SubTurret2", // name of weapon in terminal
